    ...
    <div class="content-header sty-one">
      ...
      <div class="table-responsive">
                ...
                <tbody>
                    <?php 
                    $count=1;
                        $res=mysqli_query($conn,"select * from orders where buystatus='pending' and v_id='$_SESSION[login]'");
                    if(mysqli_num_rows($res)>0){
                        ...
                        <tr>
                          ...
                          <td>
                              ...
                              <a href="veiw_order.php?id=<?php echo $row['OrderID'];?>" class="btn btn-circle btn-success "><i class="fa fa-eye"></i></a>
