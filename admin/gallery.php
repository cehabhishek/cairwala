				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2>Gallery Regular 3 columns</h2>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="isotope_container isotope row masonry-layout columns_margin_bottom_20" data-filters=".isotope_filters">
								...
								<div class="isotope-item col-lg-4 col-md-6 col-sm-12 events">
									<div class="vertical-item gallery-item content-absolute text-center ds">
										<div class="item-media">
								...
								<div class="isotope-item col-lg-4 col-md-6 col-sm-12 projects">
									<div class="vertical-item gallery-item content-absolute text-center ds">
										<div class="item-media">
								...
								<div class="isotope-item col-lg-4 col-md-6 col-sm-12 participants">
									<div class="vertical-item gallery-item content-absolute text-center ds">
										<div class="item-media">
