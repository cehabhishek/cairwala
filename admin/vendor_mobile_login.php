					...
					<div class="col-sm-12 col-md-6 col-lg-5">
						<div class="card rounded-0 border-0 mb-3">
							<div class="card-header">
								<div class="row">
									...
									<center><img src="assets/img/logo4.png"/ style="height: 148px;"></center>
										...
										<center><h5 class="card-title">Login With Mobile Number</h5></center>
									</div>
								</div>
							</div>
							<div class="card-body pr-5 pl-5">
								...
								<br>
								<form action="vendor_mobile_login_code.php" method="POST">
								<div class="form-group text-left float-label">
									<input type="text" class="form-control" name="number" placeholder='Email Mobile Number'>
									
								</div>
								<div class="form-group text-left float-label">
									<input type="password" placeholder='Enter Your Password' class="form-control pass" name="password">
								...
								<div class="text-left">
									<a href="vendor_forget_page.php" class="">Forgot Password?</a>
