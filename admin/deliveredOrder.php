  ...
  <div class="content-wrapper"> 
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> Delivered Order</li>
      </ol>
    </div>
      <div class="content">
          <div class="info-box">
      <h4 class="text-black">Delivered Order</h4>
      ...
      <div class="table-responsive">
                ...
                <tbody>
                    <?php 
                    $count=1;
                        $res=mysqli_query($conn,"select * from orders where buystatus='Approved' and DeliveryStatus='true'");
                    if(mysqli_num_rows($res)>0){
                        ...
                        <tr>
                          ...
                          <td>
                             ...
                             <a href="order.php?id=<?php echo $row['OrderID'];?> & action=deleted_order" class="btn btn-circle btn-danger "><i class="fa fa-trash"></i></a>
