...
$pay_type='';
$pay_id='';
$query="select * from orders where OrderID='$ord_id'";
...
<div style='width:300px; height:150px;float:right;margin-right:50px;margin-top:30px;'><img src='images/THE CHAIR WALA LOGO.png' style='height:110px;width:200px;'/>
