                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group has-feedback">
                        ...
                        <input class="form-control" placeholder="Product Title" type="text" name="producttitle" required>
                        <span class="fa fa-pencil form-control-feedback" aria-hidden="true"></span> </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group has-feedback">
                        <label class="control-label">Product Selling Price</label>
                        <input class="form-control" placeholder="Product Selling Price" type="text" name="productprice" required>
                        <span class="fa fa-rupee form-control-feedback" aria-hidden="true"></span> </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group has-feedback">
                        <label class="control-label">Product Quantity</label>
                        <input class="form-control" placeholder="Product Quantity" type="text" name="quntity" required>
                    ...
                    <div class="col-md-6">
                      <div class="form-group has-feedback">
                        ...
                        <input class="form-control" placeholder="Product Delivery Timing" type="text" name="product_delivery" required>
                        <span class="fa fa-clock-o form-control-feedback" aria-hidden="true"></span> </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group has-feedback">
                        <label class="control-label">Product Short Description</label>
                        <input class="form-control" placeholder="Product Short Description" type="text" name="product_s_descri" required>
                        <span class="fa fa-pencil form-control-feedback" aria-hidden="true"></span> </div>
                    </div>
                     <div class="col-md-6">
                      <div class="form-group has-feedback">
                    ...
                    <div class="col-md-12">
                      <div class="form-group has-feedback">
                        ...
                        <textarea name="product_descri" class="form-control" id="editor" rows="3"></textarea>
                      </div>
                    </div>
