					...
					<div class="col-sm-12 col-md-6 col-lg-5">
						<div class="card rounded-0 border-0 mb-3">
							<div class="card-header">
								<div class="row">
									...
									<center><img src="assets/img/logo4.png"/ style="height: 148px;"></center>
										...
										<center><h5 class="card-title">Vendor OTP</h5></center>
									</div>
								</div>
							</div>
							<div class="card-body pr-5 pl-5">
								...
								<br>
								<form action="forget_code.php?val=2" method="POST">
								...
								<br>
								<div>
									<button class="btn btn-primary btn-block col">Enter OTP</button>
									<br>
								</div>
								<div class="text-left">
